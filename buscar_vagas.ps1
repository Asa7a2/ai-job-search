...
$proc = Start-Process -FilePath "claude" -ArgumentList @("-p", $prompt, "--permission-mode", "bypassPermissions") `
    -RedirectStandardOutput "$logFile.tmp" -RedirectStandardError "$logFile.err" `
